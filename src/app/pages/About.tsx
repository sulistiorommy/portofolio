...
export function About() {
  ...
  const skills = [
    ...
    { name: "TypeScript", icon: TechIcons.typescript, category: "frontend", color: "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-800" },
    ...
    { name: "Vite", icon: TechIcons.vite, category: "frontend", color: "bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 border-purple-200 dark:border-purple-800" },
    { name: "Next.js", icon: TechIcons.nextjs, category: "frontend", color: "bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border-slate-200 dark:border-slate-700" },
    ...
    { name: "MariaDB", icon: TechIcons.mariadb, category: "database", color: "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800" },
    ...
    { name: "PM2", icon: TechIcons.pm2, category: "tools", color: "bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800" },
  ];
